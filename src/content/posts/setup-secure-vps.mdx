...
7. Check, if a reboot is required: `ls /var/run/reboot-required`. If no such file or directory exists, you’re good. If it exists, reboot the server via the Hetzner dashboard.
