...
In true [Aaron Francis](https://youtu.be/hDJ5vXRPZCE?si=9HC2d1ae1LwBD6hK) and [Josh Cirre](https://www.youtube.com/live/dxM6etLn4FE?si=fPn23VcwH093mQ_S) fashion, I’ve started to read the Laravel docs front to back. Yes, like _everything_. Sounds silly, I know, but RTFM[^1] isn’t just a saying. It’s true. And I’m lucky, cause the Laravel docs are actually written in a pretty logical, understandable and enjoyable way. I’m only currently in the [Views-Section](https://laravel.com/docs/11.x/views). But since I’ve done the Laracast course as well, many concepts make even more sense now. So I’ll keep going on that front.
